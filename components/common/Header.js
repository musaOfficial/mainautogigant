        ...
        <div className={`flex items-center ${classes.margintop}`}>
          ...
          <div className={`w-60 ${classes.widthauto} ${classes.headerbtn} relative group flex items-center justify-end md:flex-1 h-14 rounded-tl-20 rounded-tr-20 hover:bg-theme-gray-10 px-2 pb-2 pb-0 `}>
            ...
            <div className={`${classes.headerbtn} w-full sm:!w-40 md:pl-4 sm:rounded-tl-20 md:text-10 absolute z-50 uppercase invisible opacity-0 py-10 md:py-6 group-hover:visible group-hover:opacity-100 flex flex-col top-full overflow-hidden -mt-2 right-0 text-white rounded-bl-20 bg-theme-gray-10 ease-linear`}>
              <Link href="/">
                <a className="px-4 text-sm py-2 md:px-1 ease-in duration-300 hover:bg-theme-yellow hover:fill-black hover:text-black fill-white inline-flex items-center border-b border-opacity-60 hover:border-opacity-0 border-white">
              ...
              <Link href="/login">
                <a className="px-4 text-sm py-2 md:px-1 ease-in duration-300 hover:bg-theme-yellow hover:fill-black hover:text-black fill-white inline-flex items-center">
              ...
              <Link href="/dashboard/my-ads">
                <a className="px-4 py-2 md:px-1 text-sm ease-in duration-300 hover:bg-theme-yellow hover:fill-black hover:text-black fill-white inline-flex items-center">
              ...
              <Link href="/dashboard/settings">
                <a className={`${classes.settingscontainer} px-4 text-sm py-2 md:px-1 ease-in duration-300 hover:bg-theme-yellow hover:fill-black hover:text-black fill-white inline-flex items-center`}>
                  <SettingsIcon className={classes.settingsicon} />
                  Einstellungen
                </a>
              </Link>
              <button onClick={() => onMenuClick('dealer')} className="px-4 text-sm py-2 md:px-1 ease-in duration-300 hover:bg-theme-yellow hover:fill-black hover:text-black fill-white inline-flex items-center border-y border-opacity-60 hover:border-opacity-0 border-white">
              ...
              {collapse.dealerArea && <>
                <Link href="/dashboard">
                  <a className="px-4 py-2 text-sm md:px-1 ease-in duration-300 hover:bg-theme-yellow hover:fill-black hover:text-black fill-white inline-flex items-center">
              ...
              <button onClick={() => onMenuClick('cooperation')} className="px-4 text-sm py-2 md:px-1 ease-in duration-300 hover:bg-theme-yellow hover:fill-black hover:text-black fill-white inline-flex items-center">
              ...
              <button onClick={() => onMenuClick('usefull')} className="px-4 text-sm py-2 md:px-1 ease-in duration-300 hover:bg-theme-yellow hover:fill-black hover:text-black fill-white inline-flex items-center">
              ...
              <button onClick={() => onMenuClick('gigaworld')} className="px-4 text-sm py-2 md:px-1 ease-in duration-300 hover:bg-theme-yellow hover:fill-black hover:text-black fill-white inline-flex items-center">
              ...
              <Link href="/logout-success">
                <a className="px-4 text-sm py-2 md:px-1 ease-in duration-300 hover:bg-theme-yellow hover:fill-black hover:text-black fill-white inline-flex items-center border-t border-opacity-60 hover:border-opacity-0 border-white">
