        ...
        <div className={`flex items-center ${classes.margintop}`}>
          ...
          <div className={`w-60 ${classes.widthauto} relative group flex items-center justify-end md:flex-1 h-14 rounded-tl-20 rounded-tr-20 hover:bg-theme-gray-10 px-2 pb-2 pb-0`}>
            ...
            <div className="w-full sm:!w-40 md:pl-4 sm:rounded-tl-20 md:text-10 absolute z-50 uppercase invisible opacity-0 py-10 md:py-6 group-hover:visible group-hover:opacity-100 flex flex-col top-full overflow-hidden -mt-2 right-0 text-white rounded-bl-20 bg-theme-gray-10 ease-linear">
              ...
              <Link href="/login">
                <a className="px-4 py-2 md:px-1 ease-in duration-300 hover:bg-theme-yellow hover:fill-black hover:text-black fill-white inline-flex items-center">
                  <svg className="mr-2" xmlns="http://www.w3.org/2000/svg" width="12" height="11.643" viewBox="0 0 12 11.643">
              ...
              <Link href="/registration/user">
                <a className="px-4 py-2 md:px-1 ease-in duration-300 hover:bg-theme-yellow hover:fill-black hover:text-black fill-white inline-flex items-center">
                  <svg className="mr-2" xmlns="http://www.w3.org/2000/svg" width="12" height="10.117" viewBox="0 0 12 10.117">
              ...
              <Link href="/dashboard">
                <a className="px-4 py-2 md:px-1 ease-in duration-300 hover:bg-theme-yellow hover:fill-black hover:text-black fill-white inline-flex items-center">
                  <svg className="mr-2" xmlns="http://www.w3.org/2000/svg" width="12" height="6.604" viewBox="0 0 12 6.604">
              ...
              <Link href="/dealer-list">
                <a className="px-4 py-2 md:px-1 ease-in duration-300 hover:bg-theme-yellow hover:fill-black hover:text-black fill-white inline-flex items-center">
                  <svg className="mr-2" xmlns="http://www.w3.org/2000/svg" width="10" height="9" viewBox="0 0 10 9">
              ...
              <Link href="/dashboard/make-ads">
                <a className="px-4 py-2 md:px-1 ease-in duration-300 hover:bg-theme-yellow hover:fill-black hover:text-black fill-white inline-flex items-center">
                  <svg className="mr-2" xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 10 10">
              ...
              <Link href="/dashboard/my-ads">
                <a className="px-4 py-2 md:px-1 ease-in duration-300 hover:bg-theme-yellow hover:fill-black hover:text-black fill-white inline-flex items-center">
                  <svg className="mr-2" xmlns="http://www.w3.org/2000/svg" width="10" height="7" viewBox="0 0 10 7">
              ...
              <button onClick={() => onMenuClick('cooperation')} className="px-4 py-2 md:px-1 ease-in duration-300 hover:bg-theme-yellow hover:fill-black hover:text-black fill-white inline-flex items-center">
              ...
              <button onClick={() => onMenuClick('usefull')} className="px-4 py-2 md:px-1 ease-in duration-300 hover:bg-theme-yellow hover:fill-black hover:text-black fill-white inline-flex items-center">
              ...
              <button onClick={() => onMenuClick('gigaworld')} className="px-4 py-2 md:px-1 ease-in duration-300 hover:bg-theme-yellow hover:fill-black hover:text-black fill-white inline-flex items-center">
              ...
              <Link href="/logout-success">
                <a className="px-4 py-2 md:px-1 ease-in duration-300 hover:bg-theme-yellow hover:fill-black hover:text-black fill-white inline-flex items-center border-t border-opacity-60 hover:border-opacity-0 border-white">
