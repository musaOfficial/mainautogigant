...
<div className="flex items-center"><ControlledCheckbox onUpdate={val => {
  setAnzahlVorbesitzerChecked(val)
        ...
        <Sect heading={"1. Kfz-Kaufvertrag"} text={"Im Fahrzeugkaufvertrag sollten neben den standardmäßigen rechtlichen Regelungen auch individuelle Vereinbarungen und Angaben berücksichtigt werden. Der Vertrag sollte nur unterschrieben werden, wenn alle Angaben korrekt sind. Es wird empfohlen, zwei identische Exemplare des Kaufvertrags anzufertigen - eines für den Käufer und eines für den Verkäufer, beide unterschrieben. Wenn der Verkäufer minderjährig und somit nicht voll geschäftsfähig ist, sollte eine schriftliche Verkaufsvollmacht verlangt werden."} />
                <Sect heading={"2. Fahrzeugangaben"} text={"Zur eindeutigen Identifizierung eines Fahrzeugs sind die Fahrzeug-Identifikationsnummer sowie die Nummer des Fahrzeugscheins oder der Zulassungsbescheinigung II unerlässlich. Weitere wesentliche Angaben, die im Kaufvertrag nicht fehlen sollten, sind das Datum der Erstzulassung, der Kilometerstand, die Anzahl der Vorbesitzer und der nächste Termin für die Haupt- und Abgasuntersuchung."} />
                <Sect heading={"3. Unfallfrei?"} text={"Es ist ratsam, sich vom Verkäufer bestätigen zu lassen, dass das Fahrzeug unfallfrei ist. Sollte es doch zu Schäden gekommen sein, sollten Art des Schadens und die Art der Reparatur so genau wie möglich beschrieben werden. Zusätzlich sollten vom Käufer alle vorhandenen Gutachten und Rechnungen eingeholt und dem Kaufvertrag als Anlage beigefügt werden."} />
                <Sect heading={"4. Gewerbliche Einsätze"} text={"Es sollte im Kaufvertrag vermerkt werden, dass das Fahrzeug nicht gewerblich genutzt wurde, wie zum Beispiel als Miet- oder Fahrschulwagen. Wenn es sich um ein Import-Fahrzeug handelt, ist es besonders wichtig darauf hinzuweisen."} />
                <Sect heading={"5. Größere Reparaturen"} text={"Falls das Fahrzeug mit einem Austauschmotor oder einem neuen Getriebe ausgestattet wurde, sollten diese Informationen im Kaufvertrag vermerkt werden. Es ist ebenfalls ratsam, im Falle von größeren Reparaturen, die durchgeführt wurden, die Laufleistung der neuen Aggregate zu erwähnen."} />
                <Sect heading={"6. Gewerbliche Einsätze"} text={"Es sollte im Kaufvertrag vermerkt werden, dass das Fahrzeug nicht gewerblich genutzt wurde, wie zum Beispiel als Miet- oder Fahrschulwagen. Wenn es sich um ein Import-Fahrzeug handelt, ist es besonders wichtig darauf hinzuweisen."} />
                <Sect heading={"7. Größere Reparaturen"} text={"Falls das Fahrzeug mit einem Austauschmotor oder einem neuen Getriebe ausgestattet wurde, sollten diese Informationen im Kaufvertrag vermerkt werden. Es ist ebenfalls ratsam, im Falle von größeren Reparaturen, die durchgeführt wurden, die Laufleistung der neuen Aggregate zu erwähnen."} />
                <Sect heading={"8. Mängel"} text={"Falls das gewünschte Fahrzeug Mängel aufweist, sollten diese im Kaufvertrag möglichst genau beschrieben werden. Hierbei sollten Angaben zu Art, Zeitpunkt und Reparatur des Mangels gemacht werden."} />
                <Sect heading={"9. Preis"} text={"Im Kaufvertrag wird üblicherweise auch der Kaufpreis vereinbart. Der Verkäufer bestätigt in der Regel mit seiner Unterschrift, dass er die vereinbarte Summe erhalten hat. Als Käufer quittieren Sie den Erhalt des Fahrzeugs, der Schlüssel und der dazugehörigen Dokumente."} />
      </div>
    </div>
  );
}
