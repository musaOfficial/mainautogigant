            ...
            <div className={` ${classes.contentcontainer} relative w-10/12 lg:w-full max-w-ag-container md:!w-full mx-auto flex lg:flex-col bg-white p-6`}>
                ...
                <div className={classes.companydescriptioncontainer}>
                    ...
                    <div className={classes.companydesc}>
                        <h1>ÜBER UNS</h1>
                        <h3>Autogigant.at</h3>
                        <p>Der führende Online-Marktplatz auf dem österreichischen Automarkt, wurde 2022 gegründet und gehört zur GIGANT GROUP.</p>
                        <h3>Mit der Vision.</h3>
                        <p>Die führende, innovativste und zuverlässigste Technologieplattform des Automobilhandels und -Services zu sein, konzentriert sich das Team von Autogigant.at 
auf die Perfektionierung des gesamten Systems und ist bestrebt, die Erfahrung seiner Nutzer mit neuen Funktionen jeden Monat zu verbessern.</p>
                        <p>Autogigant.at ist nicht nur eine Plattform für Inserate, 
