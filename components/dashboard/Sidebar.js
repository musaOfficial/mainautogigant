...
export default function Sidebar() {
  ...
  return (
    <div
      className={`w-280 lg:top-0 lg:absolute ${
        expandSidebar ? "lg:left-0" : "lg:-left-80"
      } z-10 ${classes.backgroundcolor} ease-linear duration-300`}
    >
      {expandSidebar && (
        <div
          className="hidden lg:block fixed h-screen w-screen left-0 z-10 bg-black bg-opacity-40"
          onClick={() => setExpandSidebar(false)}
        >
          <button
            className="absolute top-4 right-4 bg-theme-yellow-6 rounded-sm p-1"
            onClick={() => setExpandSidebar(false)}
          >
            <svg
      ...
      <div className="lg:fixed z-50 lg:h-screen lg:overflow-y-scroll lg:bg-theme-gray-4">
        <div className=" pl-6 pr-6 pb-6 border-b border-opacity-15 border-theme-gray-3">
              ...
              >
                <path
                  ...
                  className={`ease-linear duration-300 fill-white group-hover:fill-theme-yellow-2 ${
                    active === "/dashboard" ? "fill-theme-yellow-2" : ""
                  }`}
                />
              </svg>
          ...
          <Link href="/dashboard/my-ads">
            <a
              className={`w-full h-12 mt-2 flex items-center text-14 group py-2 px-4 rounded-md ease-linear duration-100 text-white bg-theme-gray-10 hover:bg-theme-gray-10 hover:text-theme-yellow-2 hover:shadow-md ${
                active === "/dashboard/my-ads"
                  ? "bg-theme-gray-10 text-white shadow-md font-bold"
                  : ""
              }`}
            >
              <svg
            ...
            >
              ...
              >
                <path
                  ...
                  className={`ease-linear duration-300 fill-white group-hover:fill-theme-yellow-2 ${
                    active === "/dashboard/drafts" ? "fill-theme-yellow-2" : ""
                  }`}
                />
              </svg>
              ...
              >
                ...
                >
                  <path
                    ...
                    fill="none"
                    className={`ease-linear duration-300 stroke-white  group-hover:stroke-theme-yellow-2 ${
                      active === "/dashboard/calendar"
            ...
            <a
              className={`w-full h-12 mt-2 flex items-center text-14 group py-2 px-4 rounded-md ease-linear duration-300 text-white bg-theme-gray-10 hover:bg-theme-gray-10 hover:text-theme-yellow-2 hover:shadow-md ${
                active === "/dashboard/recharge-giga-coins"
                  ? "bg-theme-gray-10 text-theme-yellow-2 shadow-md"
                  : ""
              }`}
            >
              <svg
            ...
            >
              ...
              >
                <path
                  ...
                  className={`ease-linear duration-300 fill-white group-hover:fill-theme-yellow-2 ${
                    active === "/dashboard/bills" ? "fill-theme-yellow-2" : ""
                  }`}
                />
              </svg>
