...
export default function Sidebar() {
  ...
  return (
    <div
      ...
      } z-10 bg-theme-gray-9 ease-linear duration-300`}
    >
      {expandSidebar && (
        <div
      ...
      <div className="lg:fixed z-50 lg:h-screen lg:overflow-y-scroll lg:bg-theme-gray-4">
        <div className="p-6 border-b border-opacity-15 border-theme-gray-3">
          <Link href="/dashboard">
            <a
              className={`w-full h-12 flex items-center text-14 group py-2 px-4 rounded-md ease-linear duration-300 text-theme-gray-4 bg-white hover:bg-theme-gray-10 hover:text-theme-yellow-2 hover:shadow-md ${
                active === "/dashboard"
          ...
          <Link href="/dashboard/my-ads">
            <a
              className={`w-full h-12 mt-2 flex items-center text-14 group py-2 px-4 rounded-md ease-linear duration-100 text-theme-black-2 bg-white hover:bg-theme-gray-10 hover:text-theme-yellow-2 hover:shadow-md ${
