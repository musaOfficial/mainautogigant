...
import styles from './HomeAngebotCard.module.css';
        ...
        <div className={styles.container}>
            <div className={styles.top}>
                ...
                <div className={styles.actioncontainer}>
                    <div className={`${classes.borderright} ${classes.first}`} onMouseEnter={() => setPrintOpen(true)} onMouseLeave={() => setPrintOpen(false)}>
                    ...
                    <div className={`${classes.borderright} ${classes.last}`} onMouseEnter={() => setShareOpen(true)} onMouseLeave={() => setShareOpen(false)}>
                        ...
                        {shareOpen == true && <div className={styles.sharesvgcontainer}>
                                <div className={classes.shareitems}>
                                <div className='flex items-center'><MailIcon /><span className="ml-1 hover:text-yellow-600">E-mail</span></div>
                                <div className={classes.borderbottom}></div>
                                <div className='flex items-center'><LinkIcon /><span className="ml-1 hover:text-yellow-600">Link kopieren</span></div>
                                <div className={classes.borderbottom}></div>
                                <div className='flex items-center'><FacebookIcon /><span className="ml-1 hover:text-yellow-600">Facebook</span></div>
                                <div className={classes.borderbottom}></div>
                                <div className='flex items-center'><InstagramIcon className={classes.instaicon}/><span className="ml-1 hover:text-yellow-600">Instagram</span></div>
                                <div className={classes.borderbottom}></div>
                                <div className='flex items-center'><WhatsAppIcon /><span className="ml-1 hover:text-yellow-600">WhatsApp</span></div>
                            </div>
                        </div>}
