...
function Angebot({
    ...
    return (
        ...
        <div className={classes.actioncontainer}>
            ...
            <div className={`${classes.lefticon} ${classes.middle} ${classes.bgred}`} onClick={onClick} onMouseEnter={() => setPrintOpen(true)} onMouseLeave={() => setPrintOpen(false)}>
                <Bin className={classes.whiteicon}/>
            </div>
